...
export const canisterId = process.env.CANISTER_ID_HELLO_WORLD_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hello_world_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hello_world_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hello_world_backend.did.js")._SERVICE>}
 */
export const hello_world_backend = createActor(canisterId);
